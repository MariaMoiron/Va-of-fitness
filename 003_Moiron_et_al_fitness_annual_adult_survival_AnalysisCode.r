...
# Saving output
out <- data.frame(mean.mode      = posterior.mode(as.mcmc(post_pois[["mean.obs"]])),
                  mean.mean      = mean(as.mcmc(post_pois[["mean.obs"]])),
                  mean.low       = HPDinterval(as.mcmc(post_pois[["mean.obs"]]))[1],
                  mean.high      = HPDinterval(as.mcmc(post_pois[["mean.obs"]]))[2],
                  va.mode        = posterior.mode(as.mcmc(post_pois[["var.a.obs"]])),
                  va.mean        = mean(as.mcmc(post_pois[["var.a.obs"]])),
                  va.low         = HPDinterval(as.mcmc(post_pois[["var.a.obs"]]))[1],
                  va.high        = HPDinterval(as.mcmc(post_pois[["var.a.obs"]]))[2],
                  vp.mode        = posterior.mode(as.mcmc(post_pois[["var.obs"]])),
                  vp.mean        = mean(as.mcmc(post_pois[["var.obs"]])),
                  vp.low         = HPDinterval(as.mcmc(post_pois[["var.obs"]]))[1],
                  vp.high        = HPDinterval(as.mcmc(post_pois[["var.obs"]]))[2],
                  h2.mode        = posterior.mode(as.mcmc(post_pois[["h2.obs"]])),
                  h2.mean        = mean(as.mcmc(post_pois[["h2.obs"]])),
                  h2.low         = HPDinterval(as.mcmc(post_pois[["h2.obs"]]))[1],
                  h2.high        = HPDinterval(as.mcmc(post_pois[["h2.obs"]]))[2],
                  Ia.mode        = posterior.mode(as.mcmc(post_pois[["Ia.obs"]])),
                  Ia.mean        = mean(as.mcmc(post_pois[["Ia.obs"]])),
                  Ia.low         = HPDinterval(as.mcmc(post_pois[["Ia.obs"]]))[1],
                  Ia.high        = HPDinterval(as.mcmc(post_pois[["Ia.obs"]]))[2]
)
